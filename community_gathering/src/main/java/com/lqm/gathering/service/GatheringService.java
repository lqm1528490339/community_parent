package com.lqm.gathering.service;

import com.lqm.gathering.dao.GatheringDao;
import com.lqm.gathering.pojo.Gathering;
...
public class GatheringService {
     ...
     *
     *
     * value 参数，给该缓存数据一个别名，用在删除缓存数据的时候
     *
     * #id 把参数id值作为缓存的key（SpringCache 自动把方法返回值放入key对应的value）
     */

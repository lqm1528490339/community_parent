package com.lqm.recruit.controller;

import com.lqm.recruit.pojo.Enterprise;
import com.lqm.recruit.service.EnterpriseService;
...
public class EnterpriseController {
    ...
    public Result hotlist(){
        return new Result(true,StatusCode.OK,"查询热门列表成功",enterpriseService.hotlist());
    }
}
